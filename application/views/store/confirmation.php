...
<!-- Document Title -->
<title>Confirmation | Cake Any Time</title>
  ...
  <?php include("include/header.php"); ?>
    ...
    <section class="padding-bottom-60">
      <div class="container"> 
        ...
        <!-- Button -->
        <div class="pro-btn"> <a href="#" class="btn-round btn-light">Back to Delivery</a> <a href="checkout-successful.php" class="btn-round">Proceed to Checkout</a> </div>
      </div>
    </section>
